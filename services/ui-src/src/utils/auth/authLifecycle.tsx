...
class AuthManager {
  ...
  constructor() {
    ...
    const expiration = localStorage.getItem("mdctrhtp_session_exp");
    const isExpired =
      expiration &&
  ...
  setTimer = () => {
    ...
    localStorage.setItem("mdctrhtp_session_exp", expiration);
  };
}
...
export const refreshCredentials = async () => {
  ...
  return localStorage.getItem("mdctrhtp_session_exp");
};
