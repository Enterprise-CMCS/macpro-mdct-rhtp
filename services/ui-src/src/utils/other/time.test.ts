...
describe("utils/time", () => {
  ...
  describe("convertDateTimeEtToUtc()", () => {
    test("converts valid ET datetime to UTC correctly", () => {
  ...
  describe("convertDateUtcToEt()", () => {
    test("converts valid UTC datetime to ET correctly", () => {
  ...
  describe("formatMonthDayYear()", () => {
    test("should render dates as MM/dd/yyyy", () => {
  ...
  describe("convertDatetimeStringToNumber()", () => {
    test("should return the correct epoch for midnight", () => {
    ...
    test("should return the correct epoch for one second before midnight", () => {
      const result = convertDatetimeStringToNumber("10/22/2024", {
        hour: 23,
        minute: 59,
        second: 59,
  ...
  describe("calculateTimeLeft()", () => {
    ...
    test("checks that expiration time is greater than zero", () => {
...
describe("test parseMMDDYYYY helper function", () => {
  test("should correctly parse a valid MMDDYYYY date string", () => {
  ...
  test("should correctly parse a valid MMDDYYYY date string with single digit month/day", () => {
  ...
  test("should correctly parse a leap year date", () => {
  ...
  test("should return null for 02/29 in a non-leap year", () => {
    const date = parseMMDDYYYY("02/29/2027");
    expect(date).toBeFalsy();
  });

  test("should return null for an invalid month", () => {
    const date = parseMMDDYYYY("13/01/2023");
    expect(date).toBeFalsy();
  });

  test("should return null for an invalid day", () => {
    const date = parseMMDDYYYY("01/32/2023");
    expect(date).toBeFalsy();
  });

  test("should return null for an invalid day for a specific month", () => {
    const date = parseMMDDYYYY("04/31/2023"); // April has 30 days
    expect(date).toBeFalsy();
  });

  test("should return null for an incorrect format (missing slashes)", () => {
    const date = parseMMDDYYYY("12-25-2023");
    expect(date).toBeFalsy();
  });

  test("should return null for an incorrect format (wrong number of digits)", () => {
    const date = parseMMDDYYYY("1/2/2023");
    expect(date).toBeFalsy();
  });

  test("should return null for an incorrect format", () => {
    const date = parseMMDDYYYY("12/25/2023abc");
    expect(date).toBeFalsy();
  });

  test("should correctly parse a valid future date", () => {
  ...
  test("should return null for day or month being zero", () => {
