...
export const metricTable: ActionTableTemplate = {
  ...
  modal: {
    ...
    elements: [
      ...
      { id: "metric", type: ElementType.TextAreaField, validation: "required" },
      { id: "currValue", type: ElementType.Textbox, validation: "required" },
      { id: "date", type: ElementType.Date, validation: "date" },
    ],
  },
  rows: [
